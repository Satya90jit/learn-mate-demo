    ...
    <div className="bg-white text-black w-[23rem] h-[34rem] md:w-[23rem] md:h-[28rem] rounded-lg shadow-xl mb-2 border hover hover:border-green-600">
      <div className="p-5  ">
        <img
          ...
          alt=""
          className="w-[25rem] h-[10rem] object-cover rounded-lg  mb-5"
        />
        <div className="flex gap-9 items-center mb-5 ">
          ...
          />
          <div className="hover:text-green-600 transition delay-150 cursor-pointer">
            Akash kumar Rout
          </div>
          <button className="bg-green-100 py-1 px-6 rounded-lg text-green-500 hover:bg-green-600 hover:text-white transition delay-200">
            science
          </button>
        </div>
        <p className="mb-5 hover:text-green-600 transition delay-150 cursor-pointer">
          Lorem ipsum dolor sit amet consectetur adipisicing vero!
        </p>
